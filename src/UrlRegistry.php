...
{
    const ENVIRONMENTS = [
        'production' => env('SDK_HOST_PRODUCTION', 'https://api.dorcas.ng'),
        'staging' => env('SDK_HOST_STAGING', 'https://staging-api.dorcas.ng'),
        'local' => env('SDK_HOST_LOCAL', 'http://api.dorcas.local')
    ];
